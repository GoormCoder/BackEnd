...
public class MyPageController {
    ...
    public ResponseEntity<?> updateNick(@PathVariable String loginId, @RequestBody String newNick) {
        try {
    ...
    public ResponseEntity<?> updateInfo(@PathVariable String loginId, @RequestBody String newInfo) {
        try {
